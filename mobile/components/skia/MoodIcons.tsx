...
function getMoodColor(mood: string, theme: any): string {
  ...
  return (
    moodColors[mood.toLowerCase() as keyof typeof moodColors] ||
    theme.colors.mood.neutral
  );
}

// Preset mood icons for common emotions
export function HappyMoodIcon({
  size,
  animated,
}: {
  size?: number;
...
export function AnxiousMoodIcon({
  size,
  animated,
}: {
  size?: number;
...
export function NeutralMoodIcon({
  size,
  animated,
}: {
  size?: number;
